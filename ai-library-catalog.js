...
export const aiPromptLibrary = Object.freeze([
  ...
  { category: 'الرسائل', title: 'رسالة ترحيب واحدة', prompt: 'اكتب رسالة ترحيب واحدة للأعضاء في #[القناة] بنبرة [رسمية أو ودودة]، ثم جهزها للمراجعة.', kind: 'message' },
  { category: 'الرسائل', title: 'إعلان فعالية', prompt: 'صغ إعلان فعالية [الاسم] بتاريخ [الوقت] في #[القناة] مع طريقة المشاركة.', kind: 'message' },

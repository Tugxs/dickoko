...
function readyDecoratePreview() {
  ...
  if (logs?.enabled) {
    ...
    const note = document.createElement('small'); note.textContent = `${(logs.events || []).length || 5} أنواع أحداث · دون نص الرسائل`; box.append(note);

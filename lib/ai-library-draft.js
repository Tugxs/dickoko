...
function defaultMessage(title) {
  const messages = {
    ...
    'رسالة ترحيب واحدة': '👋 **أهلًا بك في مجتمعنا!**\nابدأ بالتعرّف على القنوات والقوانين، ثم عرّفنا بنفسك وشاركنا أول رسالة لك.',
    'تحديث مهم': '📌 **تحديث مهم**\nأجرينا تحديثًا يخص مجتمعنا. اقرأ التفاصيل هنا، وإذا احتجت مساعدة تواصل مع فريق الدعم.',
    'افتتاح سيرفر': '🎉 **أهلًا بكم في سيرفرنا!**\nهذه مساحتنا للقاء والتعاون والمشاركة. ابدأ بقراءة القوانين ثم اختر القناة التي تناسب اهتمامك.',
    'تذكير بالقوانين': '📜 **تذكير لطيف بقوانين المجتمع**\nاحترم الجميع، حافظ على موضوع كل قناة، وتجنب مشاركة المعلومات الحساسة. شكرًا لمساعدتك في إبقاء المكان مريحًا للجميع.',
    'رسالة شكر': '💜 **شكرًا لكم**\nوجودكم ومشاركاتكم هي ما يجعل هذا المجتمع مميزًا. نقدر وقتكم ودعمكم ونتطلع إلى مزيد من اللحظات الجميلة معًا.',
    'إعلان فعالية': '🎊 **فعالية قادمة**\nجهزوا أنفسكم للمشاركة! سنضع الموعد وطريقة الانضمام هنا قريبًا. تابعوا القناة حتى لا يفوتكم الإعلان.',
    'إعلان صيانة': '🛠️ **إشعار صيانة**\nنعمل على تحسين الخدمة. سنعلن هنا وقت البداية والنهاية فور تأكيدهما، ونعتذر عن أي إزعاج.',
  };
...
export function libraryDraftProposal({ mode, category, title, prompt }) {
  ...
  if (/الرسائل/.test(group)) return { operations: [], message: { channel, content: defaultMessage(name) }, review_request: prompt, draft: true };

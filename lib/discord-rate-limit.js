...
export function createDiscordRequestGate({ request = fetch, requestsPerSecond = 8, concurrency = 2, globalRequestsPerSecond = 20, globalConcurrency = 4, maxPending = 500, maxTotalPending = 600, maxWaitMs = 30_000, invalidRequestLimit = 50, invalidWindowMs = 600_000, invalidCooldownMs = 300_000 } = {}) {

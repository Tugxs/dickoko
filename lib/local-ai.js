...
export function presentAiRequest(item) {
  ...
  const interactive = ['giveaway', 'tickets', 'poll', 'event', 'welcome', 'scheduled_event', 'rules', 'channel_control'].includes(candidate?.interactive?.kind) ? candidate.interactive : null;
